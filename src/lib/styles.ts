export const inputClass =
  "w-full text-[15px] bg-[#f5f5f7] dark:bg-[#1c1c1e] dark:text-[#f5f5f7] border-0 rounded-xl px-4 py-3.5 outline-none focus:ring-2 focus:ring-[#1d1d1f]/20 dark:focus:ring-[#f5f5f7]/20 placeholder-[#b0b0b5] dark:placeholder-[#636366] disabled:opacity-60 disabled:cursor-not-allowed transition"
