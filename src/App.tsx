...
const NAV_LINKS = ["Work", "Achievements", "Contact"];
...
const ACHIEVEMENTS = [
  { icon: "◉", title: "Most Improved Award", detail: "ASEAN Manila 2025 · Web Technologies" },
  { icon: "◈", title: "Web Technologies Nationals", detail: "National Finalist · 2024" },
  { icon: "★", title: "Web Technologies Regionals", detail: "Bronze Medalist · 2023" },
  { icon: "▲", title: "3+ Years Experience", detail: "Full-stack development & UI/UX design" },
  { icon: "◆", title: "Cross-stack Proficiency", detail: "Python, Svelte, React, Laravel, Tailwind" },
  { icon: "⬡", title: "Open to Collaboration", detail: "Part-time & project-based roles" },
];

const SKILLS = ["Python", "Flask", "Svelte", "React", "Laravel", "Tailwind", "Figma", "Shell"];
...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-[#000000] text-[#1d1d1f] dark:text-[#f5f5f7] transition-colors duration-300">
      ...
      {/* Nav */}
      <motion.nav
        className="fixed top-0 left-0 right-0 z-50 bg-white/80 dark:bg-[#000000]/80 backdrop-blur-xl border-b border-[#d2d2d7]/60 dark:border-[#424245]/60"
      ...
      <section className="w-full pt-36 pb-28 px-6 bg-[#f5f5f7] dark:bg-[#0a0a0a]">
        <div className="max-w-5xl mx-auto flex flex-col lg:flex-row lg:items-start lg:justify-between gap-16">
          ...
          >
            <div className="w-[310px] h-[240px] rounded-[32px] overflow-hidden bg-[#CECECE] dark:bg-[#CECECE] mx-auto lg:mx-0">
              <video
      ...
      {/* Work */}
      <section id="work" className="py-28 px-6 max-w-5xl mx-auto">
        <motion.div
          ...
          transition={{ duration: 0.5, ease }}
        >
          <h2 className="text-[34px] font-bold tracking-[-0.02em]">Selected Work</h2>
          <span className="text-[13px] text-[#6e6e73]">{PROJECTS.length} projects</span>
        </motion.div>
              ...
              <div className="p-10 flex flex-col justify-between min-h-[260px]">
                <div>
                  <div className="flex items-center gap-3 mb-6">
                    ...
                    <span className="ml-auto text-[12px] text-[#b0b0b5]">{project.year}</span>
                  </div>
                  <motion.h3
                  ...
                  <p className="text-[15px] text-[#6e6e73] leading-relaxed max-w-sm">{project.description}</p>
                </div>
              ...
              <div className="p-8">
                ...
                >
                  ...
                  <div className="mt-8 pt-6 border-t border-[#d2d2d7]/60 dark:border-[#424245]/60 flex items-center justify-between">
                    <span className="text-[13px] text-[#b0b0b5]">{selectedProject.year}</span>
                    <button
                      onClick={() => setSelectedId(null)}
      ...
      <section id="achievements" className="py-28 px-6 max-w-5xl mx-auto">
        <motion.div
          ...
          transition={{ duration: 0.5, ease }}
        >
          <h2 className="text-[34px] font-bold tracking-[-0.02em]">Achievements</h2>
        ...
        >
          {ACHIEVEMENTS.map((item) => (
            ...
            >
              ...
              <div className="text-[17px] font-semibold tracking-[-0.01em] mb-2">{item.title}</div>
              <div className="text-[13px] text-[#6e6e73] leading-snug">{item.detail}</div>
            </motion.div>
          ))}
        </motion.div>
        ...
        >
          {STATS.map((stat) => (
            ...
            >
              <div className="text-[42px] font-bold tracking-[-0.03em] mb-1">{stat.value}</div>
      ...
      <section id="contact" className="py-28 px-6 max-w-5xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20">
          ...
          >
            <h2 className="text-[34px] font-bold tracking-[-0.02em] mb-4">Get in touch</h2>
            <p className="text-[17px] text-[#6e6e73] leading-relaxed mb-10 max-w-sm">
              Open to part-time roles and project-based collaborations. Let's build something together.
            </p>
            <div className="space-y-5">
              {[
                ...
                <a key={contact.label} href={contact.href} target="blank" className="flex items-center gap-4 group">
                  ...
                  <div>
                    <div className="text-[11px] text-[#b0b0b5] uppercase tracking-widest mb-0.5">{contact.label}</div>
                    <div className="text-[14px] font-medium group-hover:text-[#6e6e73] transition-colors">{contact.value}</div>
                  </div>
                </a>
              ))}
            </div>
              ...
              {sent ? (
                ...
                >
                  <div className="w-14 h-14 rounded-full bg-[#1d1d1f] dark:bg-[#f5f5f7] flex items-center justify-center mb-6">
                    <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" className="text-white dark:text-[#1d1d1f]" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
                      <polyline points="20 6 9 17 4 12"/>
                    </svg>
                  </div>
                  <div className="text-[20px] font-semibold mb-2">Message sent</div>
                  <div className="text-[14px] text-[#6e6e73]">I will get back to you within 24 hours.</div>
                </motion.div>
              ) : (
                <motion.form
                  key="form"
                ...
                >
                  <div>
                    <label className="block text-[12px] font-medium text-[#6e6e73] uppercase tracking-widest mb-2">Name</label>
                    <input
                      type="text"
                      required
                      value={formState.name}
                      onChange={(e) => setFormState((s) => ({ ...s, name: e.target.value }))}
                      className="w-full text-[15px] bg-[#f5f5f7] dark:bg-[#1c1c1e] dark:text-[#f5f5f7] border-0 rounded-xl px-4 py-3.5 outline-none focus:ring-2 focus:ring-[#1d1d1f]/20 dark:focus:ring-[#f5f5f7]/20 placeholder-[#b0b0b5] dark:placeholder-[#636366] transition"
                      placeholder="Your name"
                    />
                  </div>
                  <div>
                    <label className="block text-[12px] font-medium text-[#6e6e73] uppercase tracking-widest mb-2">Email</label>
                    <input
                      type="email"
                      required
                  ...
                  <div>
                    <label className="block text-[12px] font-medium text-[#6e6e73] uppercase tracking-widest mb-2">Message</label>
                    <textarea
                      required
                      rows={5}
                      value={formState.message}
                      onChange={(e) => setFormState((s) => ({ ...s, message: e.target.value }))}
                      className="w-full text-[15px] bg-[#f5f5f7] dark:bg-[#1c1c1e] dark:text-[#f5f5f7] border-0 rounded-xl px-4 py-3.5 outline-none focus:ring-2 focus:ring-[#1d1d1f]/20 dark:focus:ring-[#f5f5f7]/20 placeholder-[#b0b0b5] dark:placeholder-[#636366] resize-none transition"
                      placeholder="What are you working on?"
                    />
                  </div>
                  <motion.button
                    type="submit"
                    className="w-full bg-[#1d1d1f] dark:bg-[#f5f5f7] text-white dark:text-[#1d1d1f] text-[15px] font-medium rounded-xl py-3.5 transition-colors hover:bg-[#3d3d3f] dark:hover:bg-[#e5e5ea]"
                    whileTap={{ scale: 0.98 }}
                  >
                    Send message
                  </motion.button>
      ...
      <footer className="border-t border-[#d2d2d7]/60 dark:border-[#424245]/60 py-8 px-6">
        <div className="max-w-5xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
          <span className="text-[12px] text-[#b0b0b5]">© 2026 Lance. All rights reserved.</span>
