...
const CAPABILITIES = [
  {
    ...
    detail: "Interfaces that help customers and teams see what matters, decide faster, and keep moving.",
    stack: [
  ...
  },
  {
    ...
    detail: "Secure workflows, APIs, data, and real-time features working together as one system.",
    stack: [
  ...
  },
  {
    ...
    detail: "Fast paths from a rough idea to a tool people can test, trust, and use.",
    stack: [
...
export default function CapabilitiesSection() {
  return (
    <section id="capabilities" className="mx-auto max-w-5xl scroll-mt-20 px-6 py-14 sm:py-20">
      <SectionHeading
          ...
          >
            <div>
              <div className="mb-5 flex items-center justify-between font-mono text-[10px] uppercase tracking-[0.14em] text-[#6e6e73] dark:text-[#aaa69e] sm:mb-8">
                ...
                <span className="text-[#f05a28] dark:text-[#ffb86b]">0{index + 1}</span>
              </div>
              <h3 className={`${index === 0 ? "max-w-md text-[28px] sm:text-[36px]" : "text-[20px]"} mb-3 font-semibold leading-tight tracking-[-0.02em]`}>
                {capability.title}
              </h3>
            ...
            <div className="mt-6 flex min-h-8 items-center justify-between gap-3 border-t border-[#d2d2d7]/70 pt-4 dark:border-[#4a4b50]/70 sm:mt-8" aria-label={`${capability.title} technology stack`}>
              <span className="font-mono text-[10px] uppercase tracking-[0.1em] text-[#6e6e73] dark:text-[#aaa69e]">Working with</span>
